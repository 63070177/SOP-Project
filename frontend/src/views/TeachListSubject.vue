                ...
                <table style="width:100%; color: #fff;">
                    <tr>
                        ...
                        <tr v-for="subjects in Subject" :key="subjects.id">
                            <td><router-link @click="addSubject(subjects.subjectName)" style="color: #fff;" :to="{name: `GradePage`, params: {subjectname : subjects.subjectName}}">{{ subjects.subjectName }}</router-link></td>
...
import axios from 'axios';
    ...
    methods: {
        ...
        addSubject(name){
            localStorage.setItem('subjectName', JSON.stringify(name))
        }
    },
}
</script>