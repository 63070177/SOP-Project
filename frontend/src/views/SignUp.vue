            ...
            <div class="loginbox px-3">
                ...
                <div class="column" style="text-align: center;">
                    <div class="columns">
                        ...
                        <div class="column">
                            <div style="text-align: right; margin-top: 30px; margin-right: -35px;in">or Sign Up with 3rd Party</div>
                        </div>
                        <div class="column">
                            <button id="google" @click="signUpWithProvider" class="btn">
                                <img src="../assets/signin-button.png" alt width="100%" height="100%">
                            </button>
                        </div>
