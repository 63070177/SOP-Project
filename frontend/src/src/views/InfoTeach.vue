...
export default {
    ...
    methods: {
        ...
        editTeacher() {
            ...
            if (data.age <= 0 || data.age >60){
                alert("Age cannot be less than or equal to zero and more than 60")
            }
            else if (!data.name || !data.birth || !data.birth || !data.address || !data.phone){
